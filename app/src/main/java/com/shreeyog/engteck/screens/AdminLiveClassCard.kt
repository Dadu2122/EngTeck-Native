        ...
        if (editing) {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(10.dp), modifier = Modifier.fillMaxWidth()) {
                Box(
                    modifier = Modifier
                        .weight(1f)
                        .background(LIVE_NAVY, RoundedCornerShape(10.dp))
    ...
    fun saveBoardSnapshot() {
        ...
        coroutineScope.launch {
            try {
                ...
                val file = File(context.cacheDir, "board_snapshot_${System.currentTimeMillis()}.png")
                ...
                context.startActivity(Intent.createChooser(intent, "Share board snapshot"))
                msg = "Snapshot saved."
            } catch (e: Exception) {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Box(
            modifier = Modifier
                ...
                // Records everything drawn inside this box each frame so
                // "Save Board Snapshot" can grab exactly what's on screen —
                // slide/text/whiteboard AND any poll/MCQ/timer overlay.
                .drawWithContent {
